package com.alhanah.webcalendar.views.calendarlist;
...
@Route(value = "calendatList", layout = MainView.class)
@PageTitle("calendarList")
@CssImport("./views/calendarlist/calendar-list-view.css")
public class CalendarListView extends Div implements AfterNavigationObserver {
