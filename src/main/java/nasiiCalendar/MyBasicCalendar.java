...
//*/
 ...
 /*  
    ...
    public BasicDate getDate(int y, PeriodType m, int d)throws DateConfigException{
        ...
        if(!p.getSubPeriods().contains(m))throw new DateConfigException("month selected does not belong to year type selected.");
   ...
   //     hussam.println("ymc: "+ymc+" year: "+y+" month: "+m+" day:"+d);
    ...
    public long getStartTime(){
        return startTime;//+zoneId.getRules().getOffset(Instant.ofEpochMilli(startTime)).getTotalSeconds()*SECONDS;
    }
    ...
    public boolean equals(Object obj) {
        if(!(obj instanceof MyBasicCalendar))return false;
